...
import { ConfirmOrderHandler, CancelOrderHandler, OrderSaga } from '@doms/order/application';
...
import { OrderOrchestratorConsumer } from './order-orchestrator.consumer';

@Module({
    imports: [
        SharedUtilsModule,
        SharedRedisModule,
        SharedKafkaModule.forRootAsync({ clientId: 'order-orchestrator' }),
